  ...
  return (
    <div id="feature-section" className="relative mt-35 border-b border-neutral-800 min-h-[400px]" ref={sectionRef}>
      <div className="text-left px-5 sm:px-20 md:px-40">
        ...
        {/* Hobbies List */}
        <ul className={`mt-6 list-disc pl-5 text-lg text-white transition-opacity transition-transform duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
